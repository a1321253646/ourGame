...

{
    ...
    public class PBXProject
    {
        ...
        {
			path = UnityEditor.iOS.Xcode.PBX.Utils.FixSlashesInPath(path);
			projectPath = UnityEditor.iOS.Xcode.PBX.Utils.FixSlashesInPath(projectPath);
            ...
            if (guid == null)
            {
                ...
                if (isFolderReference)
					fileRef = PBXFileReferenceData.CreateFromFolderReference(path, UnityEditor.iOS.Xcode.PBX.Utils.GetFilenameFromPath(projectPath), tree);
                else
					fileRef = PBXFileReferenceData.CreateFromFile(path, UnityEditor.iOS.Xcode.PBX.Utils.GetFilenameFromPath(projectPath), tree);
				PBXGroupData parent = CreateSourceGroup(UnityEditor.iOS.Xcode.PBX.Utils.GetDirectoryFromPath(projectPath));
        ...
        {
			sourceGroup = UnityEditor.iOS.Xcode.PBX.Utils.FixSlashesInPath(sourceGroup);
        ...
        public void AddExternalProjectDependency(string path, string projectPath, PBXSourceTree sourceTree)
        {
			...
			CreateSourceGroup(UnityEditor.iOS.Xcode.PBX.Utils.GetDirectoryFromPath(projectPath)).children.AddGUID(fileRef.guid);
        ...
        */
        ...
        {
            PBXNativeTargetData target = nativeTargets[targetGuid];
			filename = UnityEditor.iOS.Xcode.PBX.Utils.FixSlashesInPath(filename);
			projectPath = UnityEditor.iOS.Xcode.PBX.Utils.FixSlashesInPath(projectPath);
