...
namespace Together
{
    ...
    public class TGSDK
    {
        ...
        [Obsolete("This method is obsolete, use InterstitialLoadedCallback instead")]
        public static Action<string> CPAdLoadedCallback = null;

        [Obsolete("This method is obsolete, use RewardVideoLoadedCallback, InterstitialVideoLoadedCallback instead")]
        public static Action<string> VideoAdLoadedCallback = null;

        [Obsolete("This method is obsolete, use AdCompleteCallback instead")]
        public static Action<string> AdCompleteCallback = null;


        [Obsolete("This method is obsolete use AdCloseCallback instead")]
        public static Action<string> AdRewardSuccessCallback = null;

        [Obsolete("This method is obsolete use AdCloseCallback instead")]
        public static Action<string> AdRewardFailedCallback = null;

        [Obsolete("This method is obsolete use AdShowSuccessCallback instead")]
        public static Action<string, string> BannerLoadedCallback = null;

        [Obsolete("This method is obsolete use AdShowFailedCallback instead")]
        public static Action<string, string, string> BannerFailedCallback = null;

        [Obsolete("This method is obsolete use AdClickCallback instead")]
        public static Action<string, string> BannerClickCallback = null;

        [Obsolete("This method is obsolete use AdCloseCallback instead")]
        public static Action<string, string> BannerCloseCallback = null;

        public static Action<string, string> AdShowSuccessCallback = null;

        public static Action<string, string, string> AdShowFailedCallback = null;

        public static Action<string, string> AdClickCallback = null;

        public static Action<string, string, bool> AdCloseCallback = null;

		public static Action<string> AwardVideoLoadedCallback = null;

		public static Action<string> InterstitialVideoLoadedCallback = null;

		public static Action<string> InterstitialLoadedCallback = null;
